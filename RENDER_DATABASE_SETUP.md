...
## ✅ **Your Render Database is Sufficient**
...
1. **DATABASE_URL** - ✅ Automatically set by Render (from database connection)
2. **SECRET_KEY** - ✅ Auto-generated by Render (or set manually)
3. **JWT_SECRET_KEY** - ✅ Auto-generated by Render (or set manually)
...
## 🔍 **How to Run Migration Script on Render**
...
**⚠️ Remove it after first run** to avoid running on every deployment.
...
1. **Application Logs:**
   ...
   ✅ Database tables verified. Use 'flask db upgrade' to apply migrations.
...
- Password is logged as: `⚠️ CRITICAL: Default admin password is: <password>`

---

## 📝 **Next Steps After Setup**

1. ✅ Run migration script to add permission columns
2. ✅ Log in with admin credentials
3. ✅ Change default password via `/api/auth/change-password`
4. ✅ Create additional users as needed
5. ✅ Test all modules (HVAC, Civil, Cleaning)
