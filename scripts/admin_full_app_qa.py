...
def section_admin():
    ...
    expect_page("Devices all", "/admin/devices/all")
    expect_page("Devices analytics", "/admin/devices/analytics")
    expect_page("Devices map", "/admin/devices/map")
    expect_page("Devices compliance", "/admin/devices/compliance")
    expect_page("Devices audit", "/admin/devices/audit")
    ...
    expect_json("Admin devices KPIs", "GET", "/api/admin/devices/kpis")
    expect_json("Admin devices map points", "GET", "/api/admin/devices/map-points")
    expect_json("Admin devices compliance", "GET", "/api/admin/devices/compliance")
    expect_json("Admin devices audit", "GET", "/api/admin/devices/audit")
