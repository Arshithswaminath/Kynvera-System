...
Usage:
    ...
    python tests/hr_auto_test.py --user Kynvera --password "$HR_TEST_PASSWORD"
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--password", default=os.environ.get("HR_TEST_PASSWORD") or os.environ.get("DEFAULT_ADMIN_PASSWORD") or "")
