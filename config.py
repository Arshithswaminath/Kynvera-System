...
# Public marketing deploy (kynvera.net). Off on the operations app.
KYNVERA_MARKETING_ONLY = os.getenv("KYNVERA_MARKETING_ONLY", "false").lower() in ("1", "true", "yes")
...
MAIL_DEFAULT_SENDER = os.getenv("MAIL_DEFAULT_SENDER", "contact@kynvera.net")
...
# Ticket email intake — Microsoft Graph (current) or IMAP fallback.
TICKET_INBOUND_WEBHOOK_SECRET = os.getenv("TICKET_INBOUND_WEBHOOK_SECRET")
TICKET_INTAKE_EMAIL = os.getenv("TICKET_INTAKE_EMAIL") or "contact@kynvera.net"
TICKET_INTAKE_GRAPH_TENANT_ID = os.getenv("TICKET_INTAKE_GRAPH_TENANT_ID")
TICKET_INTAKE_GRAPH_CLIENT_ID = os.getenv("TICKET_INTAKE_GRAPH_CLIENT_ID")
TICKET_INTAKE_GRAPH_CLIENT_SECRET = os.getenv("TICKET_INTAKE_GRAPH_CLIENT_SECRET")
TICKET_INTAKE_GRAPH_MAILBOX = os.getenv("TICKET_INTAKE_GRAPH_MAILBOX") or TICKET_INTAKE_EMAIL
TICKET_INTAKE_IMAP_HOST = os.getenv("TICKET_INTAKE_IMAP_HOST") or "outlook.office365.com"
TICKET_INTAKE_IMAP_PORT = int(os.getenv("TICKET_INTAKE_IMAP_PORT") or 993)
TICKET_INTAKE_IMAP_USER = os.getenv("TICKET_INTAKE_IMAP_USER") or TICKET_INTAKE_EMAIL
TICKET_INTAKE_IMAP_PASSWORD = os.getenv("TICKET_INTAKE_IMAP_PASSWORD")
TICKET_INTAKE_IMAP_FOLDER = os.getenv("TICKET_INTAKE_IMAP_FOLDER") or "INBOX"
TICKET_INTAKE_IMAP_POLL_SECONDS = int(os.getenv("TICKET_INTAKE_IMAP_POLL_SECONDS") or 60)
