  ...
  if (!document.getElementById('pwa-install-btn')) {
    ...
    if (useNavSlot) {
      ...
      installBtn.style.cssText = `
        ...
        align-items: center;
        gap: 8px;
        box-shadow: 0 4px 16px rgba(255, 142, 104, 0.4), 0 2px 8px rgba(0, 0, 0, 0.1);
        z-index: 9999;
      ...
      installBtn.addEventListener('mouseenter', () => {
        ...
        installBtn.style.boxShadow = '0 6px 20px rgba(255, 142, 104, 0.5), 0 3px 10px rgba(0, 0, 0, 0.15)';
      });
      installBtn.addEventListener('mouseleave', () => {
        installBtn.style.transform = 'translateX(0) scale(1)';
        installBtn.style.boxShadow = '0 4px 16px rgba(255, 142, 104, 0.4), 0 2px 8px rgba(0, 0, 0, 0.1)';
      });
    ...
    if (!document.getElementById('pwa-animations')) {
      ...
      style.textContent = `
        ...
        @keyframes pulse {
          ...
          50% {
            box-shadow: 0 4px 20px rgba(255, 142, 104, 0.6), 0 2px 12px rgba(0, 0, 0, 0.15), 0 0 0 4px rgba(255, 142, 104, 0.2);
          }
        }
...
function showIOSInstructions() {
  ...
  modal.innerHTML = `
    ...
    ">
      <h2 style="color: #ff8e68; margin: 0 0 20px 0; font-size: 22px;">Install Amaan App</h2>
